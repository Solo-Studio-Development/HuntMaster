package net.solostudio.huntMaster.update;
...
public class SpigotUpdateFetcher {
    ...
    private void getVersion(Consumer<String> consumer) {
        ...
        }, HuntMaster.getInstance().getScheduler()::runTaskAsynchronously);
    }

    public static void checkUpdates() {
        new SpigotUpdateFetcher(121730).getVersion(version -> {
            LoggerUtils.info(HuntMaster.getInstance().getDescription().getVersion().equals(version)
